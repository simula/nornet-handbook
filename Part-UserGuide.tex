...
% ###########################################################################
\section{The Virtual Private Network Access}
\label{sec:The-VPN-Access}
% ###########################################################################

An access via Virtual Private Network\nomenclature{VPN}{Virtual Private Network}\index{Virtual Private Network}~(VPN\index{see{Virtual Private Network}}) is planned but not yet implemented.
