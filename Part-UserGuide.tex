...
% 
% To create a public/private key pair, the following commands ca
% 
% The following example can be used to configure key-based authentication. It is supposed to run on the user's machine:
% \begin{lstlisting}
% ssh-keygen -f ~/.ssh/gatekeeper
