...
An SSH remote shell connection to the gatekeeper server\index{Gatekeeper!Secure Shell} can be established e.g.\ by:
\begin{lstlisting}
...
Secure Copy\nomenclature{SCP}{Secure Copy}\index{Secure Copy}~(SCP\index{SCP|see{Secure Copy}}) uses SSH to transfer files between machines, i.e.\ it is possible to copy files from the local machine to the gatekeeper\index{Gatekeeper!Secure Copy} and vice versa.
...
\index{Gatekeeper!Remote Synchronisation}
