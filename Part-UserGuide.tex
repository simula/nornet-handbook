...
\begin{center}
\includegraphics[width=0.98\columnwidth]{%
   Images/PDF/Kontrollsenteret-24Nov2014.pdf}
\end{center}
\caption{``NorNet-Kontrollsenter'' with Overlay Settings}
\label{cap:Kontrollsenteret-Overlay}
\end{figure*}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
\includegraphics[width=0.98\columnwidth]{%
   Images/PDF/Kontrollsenteret-Simula-24Nov2014.pdf}
\end{center}
\caption{``NorNet-Kontrollsenter'' with Site Information}
